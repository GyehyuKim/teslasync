...
- **검증 상태**: `python3 pi/test_clipserver.py` 18개 테스트 통과(healthz·목록·정렬·메타
  폴백·Range 206/416·경로 탈출 차단). **보드 배포·실차 데이터 검증은 미완**
...
- **검증 상태**: `assembleDebug` 빌드 통과. **실기(폰+보드) 연결 검증은 미완**
